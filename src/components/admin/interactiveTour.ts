...
export const startInteractiveTour = (pathname: string) => {
    ...
    steps = [
      {
        ...
        popover: {
          ...
          description: 'Di sinilah Anda mengelola seluruh konten website Mahaga Widya Cita. Anda dapat mengedit Beranda, Layanan, Tim, dan Artikel dari menu di samping ini.',
      ...
      },
      {
        ...
        popover: {
          title: 'Menu Navigasi',
          description: 'Silakan pilih salah satu menu (misal: "Beranda" atau "Articles") untuk melanjutkan panduan spesifik untuk halaman tersebut!',
          side: "right", align: 'start'
        }
      }
    ]
    ...
    steps = [
      {
        popover: {
          ...
          description: 'Di sini Anda dapat mengubah teks utama, gambar hero, statistik, daftar mitra, dan pengaturan visibilitas untuk halaman utama.',
        }
      },
      {
        element: 'button[title="Locale"]',
        popover: {
          ...
          description: 'Setiap teks yang Anda ubah di sini akan diterjemahkan otomatis. Selalu cek versi bahasa Inggris menggunakan tombol ini sebelum menyimpan.',
          side: "left", align: 'start'
        }
      },
      {
  ...
  } else if (pathname.startsWith('/admin/collections/services/') || pathname.startsWith('/admin/collections/team-members/')) {
    steps = [
      {
        popover: {
    ...
    steps = [
      {
        popover: {
          ...
          description: 'Buka menu Artikel, Layanan, atau Beranda untuk memulai tutorial terpandu cara menambahkan konten!',
        }
      }
    ]
  }
