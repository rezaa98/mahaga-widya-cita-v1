  ...
  return (
    <>
      ...
      >
        ...
        {/* Beginner-friendly language guidance banner */}
        <div className={`mwc-locale-guidance mwc-locale-guidance--${locale}`}>
          <span className="mwc-locale-guidance__icon">{locale === "id" ? "💡" : "🌐"}</span>
          <span className="mwc-locale-guidance__text">
            {locale === "id"
              ? isEn
                ? "You are currently editing the Indonesian (primary) version. Once saved, our AI automatically generates the English translation."
                : "Anda sedang mengedit versi Bahasa Indonesia (Utama). Cukup tulis dalam Bahasa Indonesia; sistem AI otomatis menyiapkan terjemahan Bahasa Inggris setelah disimpan."
              : isEn
                ? "You are currently viewing the English version generated by AI. You can freely refine any text here."
                : "Anda sedang melihat versi Bahasa Inggris (hasil AI). Anda dapat menyempurnakan tulisan jika diperlukan."}
          </span>
        </div>
