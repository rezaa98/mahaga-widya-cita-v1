    ...
    <div style={backdropStyle} onClick={handleClose}>
      <div style={modalStyle} onClick={e => e.stopPropagation()}>
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', bottom: '-80px', right: '50px', width: '150px', height: '150px', borderRadius: '50%', background: 'rgba(255,255,255,0.05)' }} />
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.2)', padding: '6px 12px', borderRadius: '100px', fontSize: '13px', fontWeight: 600, letterSpacing: '0.5px', textTransform: 'uppercase', marginBottom: '16px' }}>
              <BookOpen size={14} /> Pusat Bantuan
            </div>
            <h2 style={{ margin: '0 0 12px 0', fontSize: '28px', fontWeight: 700, letterSpacing: '-0.5px' }}>Selamat Datang di Mahaga Admin</h2>
            <p style={{ margin: 0, fontSize: '15px', opacity: 0.9, maxWidth: '500px', lineHeight: 1.5 }}>
              Pilih topik panduan interaktif di bawah ini. Sistem akan memandu Anda langkah demi langkah langsung di halaman yang bersangkutan.
            </p>
          </div>
        </div>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                    ...
                    <div style={{
                      ...
                      <ArrowRight size={16} strokeWidth={2.5} style={{ transform: isHovered ? 'translateX(2px)' : 'translateX(0)', transition: 'transform 0.3s' }} />
                    </div>
                  </div>
                  
                  <div>
                    <h3 style={{ margin: '0 0 8px 0', fontSize: '17px', fontWeight: 600, color: '#0f172a' }}>{tut.title}</h3>
                  ...
                  <div style={{ 
                    ...
                    fontSize: '13px', fontWeight: 600, color: tut.color,
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '13px', color: '#64748b' }}>Hubungi administrator sistem untuk dukungan teknis lebih lanjut.</div>
              </div>
            </div>
            <button 
              onClick={handleClose}
