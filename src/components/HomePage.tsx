...
const articles = [
  {
    ...
    excerpt: "Laporan Kinerja Instansi Pemerintah (LKJIP) merupakan dokumen vital yang mencerminkan akuntabilitas...",
  ...
  },
  {
    ...
    excerpt: "Digitalisasi bukan lagi pilihan bagi UMKM Indonesia. Di era persaingan global ini, adopsi teknologi...",
  ...
  },
  {
    ...
    excerpt: "Aparatur Sipil Negara dituntut untuk terus berinovasi dan mengembangkan kompetensi di tengah...",
...
function StatCard({ stat, index, total, visible }: { stat: StatItem; index: number; total: number; visible: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        {visible ? count.toLocaleString("id-ID") : "0"}
        {stat.suffix}
      </div>
      <div style={{ fontSize: "0.875rem", color: "var(--color-neutral-500)", fontWeight: "500" }}>{stat.label}</div>
    </div>
  );
}
          ...
          <div className="container" style={{ position: "relative", zIndex: 1, paddingBlock: "5rem" }}>
            ...
            >
              ...
              <div>
                ...
                >
                  {heroTitle} <span style={{ color: "var(--color-gold-300)" }}>{heroTitleHighlight}</span>{" "}
                  {heroTitleSuffix}
                </h1>
          ...
          <div className="container">
            ...
            >
              <div>
                <span className="badge badge-primary" style={{ marginBottom: "0.75rem" }}>
                  {isEn ? "Articles & Insights" : "Artikel & Insight"}
                </span>
                <h2 className="text-heading-xl" style={{ margin: "0" }}>
                  {isEn ? "Knowledge for Professionals" : "Pengetahuan untuk Profesional"}
                </h2>
            ...
            >
              {displayArticles.map((article: any) => (
                <Link
                  key={article.id}
                  href={getLocalizedArticleHref(locale, article.slug || article.id)}
                  style={{ textDecoration: "none", display: "block", width: "100%", maxWidth: "360px", flexGrow: 1 }}
                >
                  <div
                    className="card"
        ...
        >
          <div
            style={{
              position: "absolute",
              inset: 0,
              backgroundImage: "radial-gradient(ellipse at 30% 50%, rgba(30,111,217,0.3) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          <div className="container" style={{ position: "relative", textAlign: "center" }}>
            ...
            <div
              style={{ display: "flex", gap: "2rem", justifyContent: "center", marginTop: "2.5rem", flexWrap: "wrap" }}
            >
