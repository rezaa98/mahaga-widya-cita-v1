...
const servicesData = [
  {
    ...
    description:
      "Layanan konsultasi manajemen strategis yang dirancang untuk membantu instansi pemerintah dan swasta dalam merancang, mengimplementasikan, dan mengevaluasi sistem tata kelola yang efektif dan akuntabel.",
    ...
    benefits: [
      {
        ...
        desc: "Setiap rekomendasi didasarkan pada kajian akademis dan best practice internasional.",
      },
      { title: "Tim Pakar", desc: "Didukung para akademisi dan praktisi berpengalaman di bidang administrasi publik." },
      {
        title: "Hasil Terukur",
        desc: "Progres dan dampak konsultasi dapat diukur dengan KPI yang disepakati bersama.",
      },
      {
        title: "Pendampingan Penuh",
        desc: "Kami hadir dari perencanaan hingga evaluasi, memastikan implementasi berjalan optimal.",
      },
    ],
    targetAudience: [
  ...
  },
  {
    ...
    description:
      "Program pendidikan eksekutif dirancang khusus untuk pimpinan dan calon pimpinan instansi dengan pendekatan pembelajaran aktif, studi kasus nyata, dan fasilitasi dari pakar terbaik.",
    ...
    benefits: [
      {
        ...
        desc: "Pembelajaran berbasis diskusi, simulasi, dan studi kasus nyata dari berbagai instansi.",
      },
      { title: "Fasilitator Pakar", desc: "Dipandu oleh Guru Besar dan praktisi senior dengan rekam jejak terbukti." },
      {
        ...
        desc: "Bergabung dengan komunitas eksklusif pimpinan instansi dari seluruh Indonesia.",
      },
  ...
  },
  {
    ...
    description:
      "Pengembangan sistem informasi manajemen, aplikasi, dan infrastruktur digital yang dirancang sesuai kebutuhan spesifik instansi, mengikuti standar keamanan dan interoperabilitas pemerintah.",
    color: "#7C3AED",
    ...
    benefits: [
      {
        title: "Standar SPBE",
        desc: "Mengikuti Sistem Pemerintahan Berbasis Elektronik (SPBE) sesuai regulasi nasional.",
      },
      {
        title: "Keamanan Terjamin",
        desc: "Sistem dibangun dengan standar keamanan data sesuai peraturan yang berlaku.",
      },
      { title: "Skalabel", desc: "Arsitektur yang dapat berkembang seiring dengan kebutuhan instansi." },
      {
        title: "Dukungan Purna Jual",
        desc: "Garansi dan dukungan teknis selama minimal 1 tahun setelah serah terima.",
      },
    ],
    targetAudience: [
  ...
  },
  {
    ...
    description:
      "Layanan review komprehensif atas sistem tata kelola, kepatuhan regulasi, dan pengelolaan risiko instansi. Menghasilkan rekomendasi berbasis bukti untuk perbaikan berkelanjutan.",
    ...
    benefits: [
      {
        ...
        desc: "Review dilakukan secara independen dengan metodologi ilmiah yang terstandar.",
      },
      {
        title: "Rekomendasi Aplikatif",
        desc: "Setiap temuan disertai rekomendasi konkret yang dapat langsung diterapkan.",
      },
      {
        title: "Laporan Profesional",
        desc: "Laporan lengkap, terstruktur, dan siap dipresentasikan kepada pimpinan atau auditor.",
      },
      {
        title: "Tindak Lanjut",
        desc: "Pendampingan implementasi rekomendasi perbaikan selama periode yang disepakati.",
      },
    ],
    targetAudience: [
  ...
  },
  {
    ...
    description:
      "Platform kursus online interaktif dengan ratusan modul materi edukasi yang relevan bagi ASN dan profesional. Dilengkapi kuis, progres tracking, dan penerbitan sertifikat digital otomatis.",
    ...
    benefits: [
      { title: "Fleksibel", desc: "Belajar sesuai jadwal Anda, akses dari perangkat apa pun, kapan pun." },
      {
        ...
        desc: "Materi dirancang bersama praktisi dan akademisi yang memahami kebutuhan lapangan.",
      },
      {
        title: "Sertifikat Digital",
        desc: "Sertifikat resmi dilengkapi QR Code yang dapat diverifikasi secara publik.",
      },
  ...
  },
  {
    ...
    description:
      "Penyelenggaraan konferensi, seminar, dan forum diskusi digital profesional yang menghubungkan para pakar, pemangku kebijakan, dan praktisi dalam satu platform yang interaktif.",
    color: "#0891B2",
    ...
    benefits: [
      {
        ...
        desc: "Tidak terbatas ruang fisik, dapat diikuti oleh ribuan peserta dari seluruh dunia.",
      },
      ...
      { title: "Interaktif", desc: "Fitur tanya jawab langsung, polling, dan ruang diskusi kelompok." },
      {
        ...
        desc: "Analitik peserta, tingkat partisipasi, dan umpan balik acara secara otomatis.",
      },
    ],
    targetAudience: [
