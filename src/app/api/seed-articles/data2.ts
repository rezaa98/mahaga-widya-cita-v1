export const articlesPart2 = [
  {
    title: "Open Data: Transparansi untuk Mendorong Partisipasi Publik",
  ...
  {
    title: "Menyelaraskan Regulasi dengan Kecepatan Inovasi Teknologi",
  ...
  {
    title: "Cloud Computing: Tulang Punggung Infrastruktur Digital Pemerintahan",
  ...
  {
    title: "Smart Village: Inovasi Digital Membangun Desa Mandiri",
  ...
  {
    title: "Internet of Things (IoT) dalam Mengurai Kemacetan Perkotaan",
    imageUrl: "https://images.unsplash.com/photo-1473042904451-00171c69419d?auto=format&fit=crop&w=1200&q=80",
    paragraphs: [
  ...
  {
    title: "Keamanan Siber dalam Pemilu Digital",
  ...
  {
    title: "Mengatasi Kesenjangan Digital (Digital Divide) di Era 5.0",
  ...
  {
    title: "Pemanfaatan Drone untuk Pengawasan Tata Ruang dan Lingkungan",
  ...
  {
    title: "Chatbot AI: Garda Terdepan Customer Service Pemerintahan",
    imageUrl: "https://images.unsplash.com/photo-1520694478166-daaaaec95b69?auto=format&fit=crop&w=1200&q=80",
    paragraphs: [
  ...
  {
    title: "Menuju Arsitektur Bisnis Pemerintahan yang Tangkas (Agile)",
