export const articlesPart1 = [
  {
    title: "Masa Depan Smart City: Lebih dari Sekadar Teknologi",
  ...
  {
    title: "Urgensi Tata Kelola Data di Sektor Pemerintahan",
  ...
  {
    title: "Kecerdasan Buatan (AI) untuk Pelayanan Publik",
  ...
  {
    title: "Menavigasi UU Pelindungan Data Pribadi (PDP) di Era Digital",
  ...
  {
    title: "Membangun Ekosistem Inovasi Melalui GovTech",
  ...
  {
    title: "Manajemen Risiko TI dalam Proyek Pemerintahan",
    imageUrl: "https://images.unsplash.com/photo-1507925922888-826d7ee3a44c?auto=format&fit=crop&w=1200&q=80",
    paragraphs: [
  ...
  {
    title: "Peran Big Data dalam Pengambilan Kebijakan",
    imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80",
    paragraphs: [
  ...
  {
    title: "Cybersecurity: Benteng Pertahanan Kedaulatan Digital",
  ...
  {
    title: "Mengukur Efektivitas Aplikasi Pemerintah (GovApp)",
