export const dataPemerintah = [
  {
    title: "Implementasi SPBE: Mewujudkan Pemerintahan yang Lincah dan Responsif",
    imageUrl: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1200&q=80",
    categoryName: "Pemerintah",
    paragraphs: [
  ...
  {
    title: "Pemanfaatan Big Data untuk Pengambilan Kebijakan Berbasis Bukti (Evidence-Based Policy)",
  ...
  {
    title: "Strategi Mengatasi Resistensi Perubahan dalam Birokrasi Pemerintahan",
  ...
  {
    title: "Membangun Budaya Inovasi di Kalangan Aparatur Sipil Negara",
  ...
  {
    title: "Kolaborasi Antar Instansi: Kunci Kesuksesan Pelayanan Publik Terpadu",
  ...
  {
    title: "Menghadapi Ancaman Siber Terhadap Infrastruktur Kritis Nasional",
  ...
  {
    title: "Evaluasi Kebijakan Publik Melalui Pendekatan Citizen-Centric",
  ...
  {
    title: "Pentingnya Standarisasi Data dalam Mewujudkan Satu Data Indonesia",
    imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80",
    categoryName: "Pemerintah",
    paragraphs: [
  ...
  {
    title: "Penerapan Kecerdasan Buatan (AI) dalam Layanan Administrasi Publik",
  ...
  {
    title: "Mengukur Kinerja Instansi Melalui Indikator yang Relevan dan Terukur",
