            ...
            <>
              ...
              {totalPages > 1 && (
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "1rem", marginTop: "3rem" }}>
                  {hasPrevPage ? (
                    <Link href={`/artikel?page=${prevPage}`} style={{ padding: "0.5rem 1rem", backgroundColor: "#fff", border: "1px solid #e2e8f0", borderRadius: "8px", textDecoration: "none", color: "#1a2b4c", fontWeight: 500 }}>
                      Sebelumnya
                    </Link>
                  ) : (
                  ...
                  {hasNextPage ? (
                    <Link href={`/artikel?page=${nextPage}`} style={{ padding: "0.5rem 1rem", backgroundColor: "#fff", border: "1px solid #e2e8f0", borderRadius: "8px", textDecoration: "none", color: "#1a2b4c", fontWeight: 500 }}>
                      Selanjutnya
                    </Link>
                  ) : (
                    <span style={{ padding: "0.5rem 1rem", backgroundColor: "#f1f5f9", border: "1px solid #e2e8f0", borderRadius: "8px", color: "#94a3b8", cursor: "not-allowed", fontWeight: 500 }}>
