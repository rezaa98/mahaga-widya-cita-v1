...
const values = [
  {
    icon: Award,
    title: "Integritas",
    desc: "Kami menjunjung tinggi kejujuran dan profesionalisme dalam setiap layanan yang kami berikan.",
  },
  {
    icon: Target,
    title: "Inovasi",
    desc: "Selalu menghadirkan solusi mutakhir yang relevan dengan dinamika kebijakan dan teknologi terkini.",
  },
  {
    icon: Users,
    title: "Kolaborasi",
    desc: "Membangun ekosistem kemitraan yang saling menguatkan antara akademisi, praktisi, dan pemerintah.",
  },
  {
    icon: Globe,
    title: "Dampak",
    desc: "Setiap program dirancang untuk memberikan dampak nyata bagi peningkatan kualitas tata kelola Indonesia.",
  },
];
        ...
        <div className="container" style={{ position: "relative" }}>
          <div style={{ maxWidth: "640px" }}>
            ...
            <h1 className="text-display" style={{ color: "white", marginBottom: "1.25rem" }}>
              ...
              <span style={{ color: "var(--color-gold-300)" }}>Tata Kelola & Edukasi</span>
            </h1>
            <p style={{ fontSize: "1.125rem", color: "rgba(255,255,255,0.75)", lineHeight: "1.7" }}>
              PT Mahaga Widya Cita hadir sebagai jembatan antara kebutuhan penguatan kapasitas SDM dengan solusi berbasis pengetahuan dan teknologi terkini di Indonesia.
            </p>
          </div>
        </div>
