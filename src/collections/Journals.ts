  ...
  fields: [
    {
      ...
      tabs: [
        ...
        },
        {
          ...
          admin: {
            description:
              "Upload cover dan PDF final, lalu lengkapi metadata penerbitan agar jurnal mudah ditemukan dan dikutip.",
          },
          fields: [
            {
              name: "coverImage",
    ...
    },
    {
      ...
      access: { update: canManageContent },
      hooks: {
        beforeValidate: [({ value, data }) => slugify(value) || slugify(data?.title) || value],
      },
    },
    {
      name: "author",
