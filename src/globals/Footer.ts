  ...
  fields: [
    {
      ...
      type: 'textarea',
      required: true,
      defaultValue: 'Platform terdepan untuk edukasi profesional dan penguatan tata kelola bagi ASN dan profesional Indonesia.',
    },
    {
      name: 'socialMedia',
      label: 'Media Sosial',
    ...
    },
    {
      ...
      admin: {
        description: 'Tahun akan ditambahkan secara otomatis (contoh: © 2026 PT Mahaga Widya Cita. Hak Cipta Dilindungi.)',
      },
    },
  ],
}
